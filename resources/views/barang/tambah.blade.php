    ...
    <div class="row row-cols-10 shadow rounded-lg p-3 justify-content-center m-0"
        ...
        <div class="col-9">
            ...
            <div class="tab-content bg-light rounded-lg shadow p-4" id="v-pills-tabContent">
                ...
                <hr>
                <form method="POST" action="{{ Route('Barang') }}/{{ $user->id }}/Tambah">
                    @csrf
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control justify-content" id="catatan_barang" placeholder="Ketikkan Catatan Barang.." name="catatan_barang" value="{{ old('catatan_barang') }}">
                        </div>
                    </div>

                    <button type="submit" class="btn btn-primary btn-md float-right">Tambah Barang</button>
                </form>
                <br>
                <br>
                <hr>
