...
<head>
    ...
    <title>{{ config('app.nama', 'SIMAKALAH') }} - @yield('title')</title>
    <link rel="shortcut icon" href="{{ asset('img/logosmp4.png') }}" type="image/x-icon">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ url('/') }}" style="font-weight:bold;">
                    <img src="{{ asset('img/logosmp4.png') }}" alt="Logo" width="50px">
                    {{ config('app.nama', 'Sistem Informasi Manajemen Laboratorium Komputer Sekolah') }} SMP Negeri 4 Ponorogo
                </a>
