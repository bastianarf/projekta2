    ...
    <div class="row row-cols-10 shadow rounded-lg p-3 justify-content-center m-0"
        ...
        <div class="col-9">
            ...
            <div class="tab-content bg-light rounded-lg shadow p-4" id="v-pills-tabContent">
                ...
                @endif
                <h3 class="text-center">Tambah Data Peminjaman Barang </h3>
                <hr>
                <form method="POST" action="{{ Route('Peminjaman') }}/{{ $user->id }}/Tambah">
                    @csrf
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <select id="kode_barang" name="kode_barang" class="form-control form-control-user @error('kode_barang') is-invalid @enderror" required placeholder="Pilih Kode Barang">
                                <option selected disabled>- Pilih Kode dan Nama Barang -</option>
                                    ...
                                    <option value="{{ $data_barang->kode_barang }}"> {{ $data_barang->kode_barang }} - {{ $data_barang->nama_barang }}</option>
                                    @endforeach   
                                        </select>
                                        @error('kode_barang')
                                        <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <select id="merk_barang" name="merk_barang" class="form-control form-control-user @error('nama_barang') is-invalid @enderror" required placeholder="Pilih Merk Barang">
                                <option selected disabled>- Pilih Merk Barang -</option>
                                    @foreach ($barang as $data_barang)
                                    <option value="{{ $data_barang->merk_barang }}"> {{ $data_barang->nama_barang }} - {{ $data_barang->merk_barang }}</option>
                                    @endforeach   
                                        </select>
                                        @error('merk_barang')
                                        <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <select id="warna_barang" name="warna_barang" class="form-control form-control-user @error('warna_barang') is-invalid @enderror" required placeholder="Pilih Warna Barang">
                                <option selected disabled>- Pilih Warna Barang -</option>
                                    @foreach ($barang as $data_barang)
                                    <option value="{{ $data_barang->warna_barang }}"> {{ $data_barang->nama_barang }} - {{ $data_barang->warna_barang }} - {{ $data_barang->merk_barang }}</option>
                                    @endforeach   
                                        </select>
                                        @error('warna_barang')
                                        <span class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="date" class="form-control justify-content" id="tgl_pinjam" placeholder="Masukkan Tanggal Peminjaman Barang.." required name="tgl_pinjam" value="{{ old('tgl_pinjam') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="date" class="form-control justify-content" id="tgl_kembali" placeholder="Masukkan Tanggal Pengembalian Barang.." required name="tgl_kembali" value="{{ old('tgl_kembali') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control justify-content" id="keterangan" placeholder="Ketikkan Keterangan Barang.." name="keterangan" value="{{ old('keterangan') }}">
                        </div>
                    </div>
