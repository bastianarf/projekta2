    ...
    <div class="row row-cols-10 shadow rounded-lg p-3 justify-content-center m-0"
        ...
        <div class="col-9">
            ...
            <div class="tab-content bg-light rounded-lg shadow p-4" id="v-pills-tabContent">
                ...
                <hr>
                <form method="POST" action="{{ Route('Pengajuan') }}/{{ $pengajuan->id }}/Edit">
                    @method('patch')
                    @csrf
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-7">
                            <input type="text" class="form-control justify-content" id="kode_barang" placeholder="Ketikkan Kode Barang.." required name="kode_barang" value="{{ $pengajuan->kode_barang }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control justify-content" id="nama_barang" placeholder="Ketikkan Nama Barang.." required name="nama_barang" value="{{ $pengajuan->nama_barang }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="number" class="form-control justify-content" id="qty_barang" placeholder="Ketikkan Qty Barang.." required name="qty_barang" value="{{ $pengajuan->qty_barang }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <select id="ruangan_barang" name="ruangan_barang" class="form-control form-control-user @error('ruangan_barang') is-invalid @enderror" required placeholder="Pilih Ruang Laboratorium">
                                <option selected disabled>- Pilih Laboratorium Komputer -</option>
                                    <option value="Laboratorium Komputer 1" @if ($pengajuan->ruangan_barang =='Laboratorium Komputer 1') selected @endif>Laboratorium Komputer 1</option>
                                    <option value="Laboratorium Komputer 2" @if ($pengajuan->ruangan_barang =='Laboratorium Komputer 2') selected @endif>Laboratorium Komputer 2</option>
                                    <option value="Laboratorium Komputer 3" @if ($pengajuan->ruangan_barang =='Laboratorium Komputer 3') selected @endif>Laboratorium Komputer 3</option>
                                        </select>
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control justify-content" id="merk_barang" placeholder="Ketikkan Merk Barang.." required name="merk_barang" value="{{ $pengajuan->merk_barang }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control justify-content" id="warna_barang" placeholder="Ketikkan Warna Barang.." required name="warna_barang" value="{{ $pengajuan->warna_barang }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="number" class="form-control justify-content" id="hargasatuan_barang" placeholder="Ketikkan Harga Satuan Barang.." required name="hargasatuan_barang" value="{{ $pengajuan->hargasatuan_barang }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="date" class="form-control justify-content" id="tgl_pengajuan" placeholder="Pilih Tanggal Pengajuan.." required name="tgl_pengajuan" value="{{ $pengajuan->tgl_pengajuan }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row d-flex align-items-center">
                        ...
                        <div class="col-sm-1 text-right">:</div>
                        <div class="col-sm-7">
                            <input type="text" class="form-control justify-content" id="keterangan_barang" placeholder="Ketikkan Keterangan Barang.." name="keterangan_barang" value="{{ $pengajuan->keterangan_barang }}">
                        </div>
                    </div>
