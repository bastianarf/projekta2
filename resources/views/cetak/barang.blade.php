...
// Set Judul
$pdf->SetTitle('Laporan Barang - '.$user->id."/".date('Y')." - ".$user->nama_lengkap." - ".strtotime(now()));
//  Tambah Halaman
$pdf->AddPage();
// Font
...
$pdf->Cell(0,6,'LAPORAN DATA INVENTARIS BARANG',$border,1,'C');
...
$no = 1;
$tabelbarang=new easyTable($pdf, '{10, 27, 31, 23, 27, 27, 27, 27, 27, 10}', 'width:220; font-size:10; border:1; paddingY:2;');
 ...
 $tabelbarang->easyCell("KONDISI");
 $tabelbarang->easyCell("CATATAN");
 $tabelbarang->printRow();
 $total = 0;

 foreach($barang as $data_barang) {
    QRCode::png($data_barang->kode_barang,"kodebarangadmin.png");
    $tabelbarang->rowStyle(';');
    $tabelbarang->easyCell($no++, 'font-size:10; align:C; valign:T');
    $tabelbarang->easyCell('','img:kodebarangadmin.png');
    $tabelbarang->easyCell($data_barang->nama_barang, 'font-size:10; align:L; valign:T');
    $tabelbarang->easyCell($data_barang->qty_barang, 'font-size:10; align:C; valign:T');
    $tabelbarang->easyCell($data_barang->ruangan_barang, 'font-size:10; align:L; valign:T');
    $tabelbarang->easyCell($data_barang->merk_barang, 'font-size:10; align:L; valign:T');
    $tabelbarang->easyCell($data_barang->warna_barang, 'font-size:10; align:L; valign:T');
    $tabelbarang->easyCell($data_barang->kondisi_barang, 'font-size:10; align:L; valign:T');
    $tabelbarang->easyCell($data_barang->catatan_barang, 'font-size:10; align:L; valign:T');
    $tabelbarang->printRow();
 }
 ...
 if ($user->role_check(['Kepala Laboratorium'])){
 $no = 1;
 $tabelbarang=new easyTable($pdf, '{10, 31, 39, 23, 31, 31, 31, 31, 10}', 'width:220; font-size:10; border:1; paddingY:2;');

 $tabelbarang->rowStyle('align:{CCCCCCCC}; font-style:B');
 $tabelbarang->easyCell("NO");
 $tabelbarang->easyCell("KODE BARANG");
 $tabelbarang->easyCell("NAMA BARANG");
 $tabelbarang->easyCell("JUMLAH");
 ...
 $total = 0;
     ...
     foreach($baranglab as $data_barang) {
        QRCode::png($data_barang->kode_barang,"kodebarangkalab.png");
        $tabelbarang->rowStyle(';');
        $tabelbarang->easyCell($no++, 'font-size:10; align:C; valign:T');
        $tabelbarang->easyCell('','img:kodebarangkalab.png');
        $tabelbarang->easyCell($data_barang->nama_barang, 'font-size:10; align:L; valign:T');
        $tabelbarang->easyCell($data_barang->qty_barang, 'font-size:10; align:C; valign:T');
        $tabelbarang->easyCell($data_barang->merk_barang, 'font-size:10; align:L; valign:T');
        $tabelbarang->easyCell($data_barang->warna_barang, 'font-size:10; align:L; valign:T');
